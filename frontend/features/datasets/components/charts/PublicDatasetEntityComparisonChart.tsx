...
import { usePublicDatasetEntityComparison } from "@/features/datasets/public/timeseries/hooks/usePublicDatasetEntityComparison";
import { usePublicDatasetMeta } from "@/features/datasets/public/meta/hooks/usePublicDatasetMeta";
...
export const PublicDatasetEntityComparisonChart = ({ datasetId }: Props) => {
  ...
  const {
    ...
    isError: isMetaError,
  } = usePublicDatasetMeta(datasetId);
  ...
  const {
    ...
    isError: isDataError,
  } = usePublicDatasetEntityComparison(datasetId, actualMetric);
